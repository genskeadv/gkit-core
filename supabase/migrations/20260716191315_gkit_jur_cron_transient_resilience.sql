-- Keep recently unstable DataJud processes from dominating the automatic cron queue.
-- Targeted syncs with p_processo_id still run immediately for manual recovery.
