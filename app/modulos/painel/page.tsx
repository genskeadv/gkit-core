...
const shortcutGroups = [
  ...
  },
  {
    ...
    links: [
      { href: '/modulos/gkit-fat', label: 'Cockpit' },
      { href: '/modulos/gkit-fat/contratos', label: 'Contratos' },
      { href: '/modulos/gkit-fat/faturas', label: 'OS e Faturas' },
      { href: '/modulos/gkit-fat/uber', label: 'Uber' },
      { href: '/modulos/gkit-fat/configuracoes', label: 'Configuracoes' },
    ],
    pending: [],
  },
  {
