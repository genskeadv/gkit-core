...
export default async function GkitFlexEditarColaboradorPage({ params }: { params: Promise<{ id: string }> }) {
  const { id } = await params;
  const context = await requireModuleAccess('gkit-flex', `/modulos/gkit-flex/colaboradores/${id}`);
