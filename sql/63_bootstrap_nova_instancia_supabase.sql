...
values
  ...
  ('uber', 'GKIT Uber', 'Lancamento e acompanhamento de despesas de Uber sem depender do Colab.', 'ativo', '/modulos/uber', 45),
  ...
  ('gkit_fat', 'GKIT FAT', 'Faturamento de servicos advocaticios 03220 com contratos, OS e NFS-e.', 'ativo', '/modulos/gkit-fat', 65),
...
with perms(codigo, nome, descricao, app_codigo, recurso, acao) as (
  values
    ...
    ('uber.read', 'GKIT Uber - ler despesas', 'Consultar despesas de Uber do usuario.', 'uber', 'uber', 'read'),
    ('uber.write', 'GKIT Uber - lancar despesas', 'Lancar despesas de Uber com recibo para reembolso.', 'uber', 'uber', 'write'),
    ...
    ('gkit_fat.uber.read', 'GKIT FAT - ler Uber', 'Consultar relatorios, lancamentos e pendencias de Uber.', 'gkit_fat', 'gkit_fat.uber', 'read'),
    ('gkit_fat.uber.write', 'GKIT FAT - conciliar Uber', 'Importar relatorios e atualizar status de reembolso Uber.', 'gkit_fat', 'gkit_fat.uber', 'write'),
