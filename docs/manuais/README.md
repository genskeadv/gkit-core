# Manuais de uso dos modulos GKIT

Este diretorio reune guias operacionais para os principais modulos da plataforma.
Os manuais foram escritos para uso diario: o foco esta em o que cada modulo faz,
quando usar cada tela e quais cuidados tomar antes de registrar, importar,
aprovar ou faturar informacoes.
...
1. Comece pelo manual do modulo que voce vai operar.
2. Confira a secao "Como acessar" para localizar a tela correta.
3. Use "Rotina recomendada" como checklist de trabalho.
4. Consulte "Boas praticas" antes de fechar, aprovar ou gerar registros financeiros.
5. Em caso de permissao bloqueada, consulte o manual do Core.

## Observacoes gerais

- As rotas podem depender do perfil de acesso do usuario.
